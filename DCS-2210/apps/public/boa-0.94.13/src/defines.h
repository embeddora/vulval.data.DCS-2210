...
#ifdef DAVINCI_IPCAM
#include <ipnc_define.h>  // add by Alex, 2009.04.20
#else
#error "NOT DEFINE DAVINCI_IPCAM"
#endif
...
#define SUBSTREAM_MASK			0x000F
#define FMT_MASK				0xFF00

#define URI_STREAM_NONE			0x000
#define URI_STREAM_JPEG			0x100
#define URI_STREAM_MJPEG		0x200
#define URI_STREAM_MPEG4		0x300
#define URI_STREAM_H264 		0x400
#define URI_AUDIO_G726			0x500
#define URI_DLINK_STREAM_MPEG4  0x600
#define URI_NOTIFY_STREAM		0x700
#define URI_HTTP_MJPEG			0x800
#define URI_HTTP_MPEG4			0x900
#define URI_AUDIO_STREAM		0xA00
#define URI_STREAM_AVC			0xB00
#define URI_DLINK_STREAM_H264   0xC00
...
#define CONFIG_STREAM_TIMEOUT
#define STREAM_TIMEOUT_SEC		(20)  // seconds

#undef CONFIG_STREAM_LIMIT
#define MAX_STREAM_LIMIT		10

//#define BOA_OSD_DEBUG
#ifdef BOA_OSD_DEBUG
#define DBG_BLOCKED_SOCKET
#define PST_BLOCKED_SOCKET		6
#endif // BOA_OSD_DEBUG
...
#define SINGLE_POST_LIMIT_DEFAULT               (20*1024*1024) //1024 * 1024 /* 1 MB */
...
#define HTTP_PARSE_LENGTH			8192			//(sdlist used 8192) add by jiahung, 20090522
...
#define ERROR_SERVICE_UNAVAILABLE	-2
